...
var GMapsLatLonPicker = (function() {
	...
	_self.params = {
		...
		strings : {
			markerText : "Arrastre este Marker", 
			error_empty_field : "No se pudo encontrar las coordenadas de este lugar ",
			error_no_results : "No se pudo encontrar las coordenadas de este lugar "
		}
	};
	...
	var publicfunc = {
		...
		init : function(object) {
			...
			$(_self.vars.cssID + ".gllpSearchButton").bind("click", function() {
				...
				$('#ubicacion_actual').hide();
				$('#ubicacion_seleccionada').show();
